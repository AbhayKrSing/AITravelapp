          ...
          <div className="flex-row-sb">
            <div className="flex-column">
              ...
              <div className="flex-row chips">
                ...
                <div>🥂 No. of Traveler: {noOfTraveler} People</div>
              </div>
            </div>
      ...
      locations : [
        {
          ...
          "description" : "A beautiful temple dedicated to Lord Shiva, known for its intricate carvings and peaceful atmosphere.",
          "duration" : "30 minutes",
          "cost" : "Free"
        },
        {
